...
class TestObservation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.U_flux_conversion_factor = 417.5E-11
        self.B_magnitude = 18.793
        self.B_flux_conversion_factor = 632.0E-11
    ...
    def test_observation_converts_Johnson_U_zero_magnitude_to_flux(self):
        ...
        magnitude = 0
        uncertainty = 0
        my_obs = mag2flux.Observation(magnitude, uncertainty, self.U_flux_conversion_factor)
        flux = my_obs.convert_to_flux()
        self.assertEqual(flux, self.U_flux_conversion_factor)
    ...
    def test_observation_converts_Johsnon_B_zero_magnitude_to_flux(self):
        ...
        magnitude = 0
        uncertainty = 0
        my_obs = mag2flux.Observation(magnitude, uncertainty, self.B_flux_conversion_factor)
        flux = my_obs.convert_to_flux()
        self.assertEqual(flux, self.B_flux_conversion_factor)
    ...
    def test_observation_converts_Johnson_U_nonzero_magnitude_to_flux(self):
        ...
        expected_flux = self.U_flux_conversion_factor * 10**(-0.4 * self.U_magnitude)
        my_obs = mag2flux.Observation(self.U_magnitude, self.uncertainty, self.U_flux_conversion_factor)
        flux = my_obs.convert_to_flux()
    ...
    def test_observation_converts_Johnson_B_nonzero_magnitude_to_flux(self):
        ...
        expected_flux = self.B_flux_conversion_factor * 10**(-0.4 * self.B_magnitude)
        my_obs = mag2flux.Observation(self.B_magnitude, self.uncertainty, self.B_flux_conversion_factor)
        flux = my_obs.convert_to_flux()
        self.assertEqual(flux, expected_flux)
